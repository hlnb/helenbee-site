...
tags:
  ...
  - personal journey
category: reflection
image: /images/uploads/prophsee-journals-bx-n-0sz8gg-unsplash.jpg
image_alt: ''
author:
  name: Helen Burgess
socials:
...
bluesky_description: |-
  I'm not ending 2025 with a list of achievements or bold declarations.
    This year taught me that healing doesn't announce itself — it accumulates.
    In small shifts. Quieter choices. Permission to rest without justification.
    A closing thought:
    What are you carrying forward into the new year — not as a goal, but as a way of being?
...
facebook_description: |-
  I'm closing 2025 quietly.
    No achievement lists. No bold resolutions. Just honest reflections on what
    this year taught me about healing, guilt, creativity, and working at a human
    pace.
    If there's a single thread running through this year, it's this: healing
    doesn't announce itself. It accumulates — in small shifts, quieter choices,
    and permission to rest without justification.
    As the year ends, I'm not setting goals so much as intentions for how I want
    to be inside whatever comes next.
    A gentle question for you:
    What are you carrying forward into the new year — not as a goal, but as a way of being?
    I'd love to hear what's sitting with you as this year closes.
newsletter: true
draft: false
---
