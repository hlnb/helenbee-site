...
title: 'The Rules Were Written Down: AuDHD, Structure, Service, and What Came After'
subtitle: ''
...
keywords:
  - AuDHD veterans
  - moral injury
  - neurodivergent military
  - RAAF mental health
  - AuDHD identity
  - autistic ADHD veteran
...
image_credit:
  ...
  profile_url: https://unsplash.com/@adp60?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText
  photo_url: https://unsplash.com/photos/interior-of-a-long-empty-warehouse-with-concrete-floor-rP-kqmI-oS0?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText
author:
  name: Helen Burgess
socials:
...
bluesky_description: The RAAF gave me structure my AuDHD brain had been searching for. The same institution failed me. Both things are true — and the AuDHD lens is the only one that lets me hold them at once.
mastodon_description: 'Part 2 of my AuDHD series: on military structure, moral injury, and what it costs when the people who looked like support were working from their own hidden version of who you are.'
facebook_description: New post — the second in my AuDHD series. On the RAAF, structure, moral injury, and learning the hard way who was actually in your corner.
newsletter: true
draft: false
---

_This is the second in a series of reflections on AuDHD, identity, and lived experience through service and beyond. The first piece is_ [_What I Finally Have Words For_](#)_._
...
What I didn't say — because I was still circling it — was how profound that was. Not convenient. Not useful. _Profound._
...
What coming to understand myself as AuDHD gave me — and I use _gave_ deliberately, even though it arrived late and came with its own grief — was a framework for understanding why I responded to both versions the way I did.

The structure worked _because of_ my neurology, not despite it. My brain was not broken; it was finally in an environment shaped for it.

The harm landed as hard as it did _because of_ my neurology, not despite it. The absence of a firewall, the depth of the trust I'd extended, the inability to fully process what was happening through the social-cue-reading channels that neurotypical people rely on — all of that is relevant context.
...
But I do have this: the two things can be true at the same time. The structure held you _and_ it let you down. The years that worked were real _and_ the harm was real. You were not wrong to trust _and_ the trust was violated.
