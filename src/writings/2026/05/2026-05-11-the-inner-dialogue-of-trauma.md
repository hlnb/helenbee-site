...
A good review. Genuine words from people I respected â€” words that said I was doing the work well, that I was valued, that I was on the right track. And then: the promotion that went somewhere else.
...
I didn't argue with it. That's the thing I've had to sit with â€” I didn't argue, because some part of me believed it was right. Not consciously. Not as a position I'd examined and adopted. Just â€” present. A low-level certainty that the evidence in favour of me was circumstantial, and the evidence against me was structural. That I was a mistake they hadn't quite caught yet.

That voice is what I want to write about.

---

Most people who carry trauma don't experience it as flashbacks or nightmares â€” at least not only as those things. They experience it as a layer. A persistent, low-frequency dialogue that runs beneath whatever else is happening. You can be driving, or sitting in a meeting, and the voice is there. Not loud. Not dramatic. Just *present*. Commenting. Assessing. Finding evidence.
...
I experienced that directly. Offered care, I deflected. Offered support, I minimised. Not because I didn't want help â€” I did â€” but because something in me had decided I hadn't warranted it yet. That I needed to fix something first, prove something first. The voice had set conditions I couldn't meet because it moved the bar whenever I got close.

---

I'm writing this because I think the inner dialogue of trauma is one of the least-talked-about aspects of what survivors carry. We discuss flashbacks and hypervigilance. We discuss the ways trauma reshapes relationships and the nervous system's response to threat. But the quiet, persistent internal commentary â€” the voice that runs in the background of an ordinary Tuesday, that finds the crack in every good thing and widens it â€” gets less airtime. Perhaps because it's harder to describe. Perhaps because it looks, from the outside, like a personality trait rather than a symptom.

It is not a personality trait.

The research is clear on this. The inner critic in trauma and C-PTSD is a documented, clinical feature. The thought *I am not good enough* is not a conclusion your mind has drawn from careful observation. It is an artefact of injury â€” a voice installed by experience, running on a loop, convinced of its own accuracy in the way that only things we never consciously chose can be.

That doesn't make it quiet. I won't pretend understanding it intellectually has silenced it. But it has changed my relationship to it. I no longer give it the authority of truth. I know what it is now, which means I can notice it â€” *there it is again* â€” without having to respond to it as though it were a verdict.
...
*If you recognise this voice â€” the one that shows up when things go wrong, or when something good happens that you can't quite believe â€” I'd like to hear from you. Not to fix it. Just to acknowledge that it's real, and that you're not alone in carrying it.*

---

**Sources**

- Pete Walker â€” [Shrinking the Inner Critic in Complex PTSD](https://pete-walker.com/shrinkingInnerCritic.htm)
- VA National Centre for PTSD â€” [Moral Injury](https://www.ptsd.va.gov/professional/treat/cooccurring/moral_injury.asp)
- Gagnepain et al. (2017) â€” [Accounting for intrusive thoughts in PTSD: Contributions of cognitive control](https://pmc.ncbi.nlm.nih.gov/articles/PMC4728012/) â€” *Neuropsychologia*, PMC
- Williamson et al. (2022) â€” [Impact and Risk of Moral Injury Among Deployed Veterans](https://www.frontiersin.org/journals/psychiatry/articles/10.3389/fpsyt.2022.899084/full) â€” *Frontiers in Psychiatry*
```
