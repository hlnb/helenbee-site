...
title: The Table I Know I’ll Be At
subtitle: Low-demand connection, belonging after service, and the quiet value of being expected somewhere.
description: After leaving the RAAF, belonging was harder to rebuild than I expected. This reflection explores low-demand connection, veteran loneliness, and why an ordinary weekly coffee table can be enough.
excerpt: For a long time, I thought connection had to be deep to count. Then I began to understand the quiet value of a weekly coffee table, familiar faces, and the kind of belonging that asks very little except that I show up.
date: 2026-05-25T09:00:00+08:00
publishedDate: 2026-05-25T09:00:00+08:00
theme: Connection
keywords:
  - connection,
  - belonging,
...
bluesky_description: For a long time, I thought connection had to be deep to count. This piece is about veteran transition, loneliness, and the quiet value of a weekly coffee table where nothing has to be processed.
mastodon_description: |-
  For a long time, I thought connection had to be deep to count.

  This piece reflects on leaving the RAAF, the loss of built-in belonging, and the quiet value of low-demand connection — a weekly coffee table, familiar faces, and the relief of being expected somewhere without needing to explain everything.
facebook_description: |-
  When I left the RAAF, I did not yet have the language for what I had lost.

  It was not only structure or role. It was belonging — the kind that came built into service life.

  This reflection is about rebuilding connection in smaller, quieter ways: a weekly coffee table, familiar faces, ordinary conversation, and the discovery that low-demand connection still counts.
newsletter: true
draft: false
---
